                                ...
                                <div class="card-body">
                                    <div class="register-form">
                                        ...
                                        <form action="addproduct" method="POST" id="addProductForm"
                                            name="addProductForm" class="row g-3" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                <div class="group-input ">
                                                    ...
                                                    <i class="fa fa-check-circle" aria-hidden="true"
                                                        style="top: 55px;right: 25px;"></i><br>
                                                    <i class="fa fa-exclamation-circle" aria-hidden="true"
                                                        style="top:  55px;right: 25px;"></i>
                                            ...
                                            <div class="col-md-6 defaultBorders">
                                                <label for="countriesLabel" class="form-label registerLabel">Categories
                                                    *</label>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="defaultBorders">
                                                    ...
                                                    <input class="form-control form-control-lg product-image"
                                                        type="file"  id="productImage"
                                                        class="defaultBorders" name="productImage"  required>
