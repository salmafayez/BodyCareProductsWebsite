                        ...
                        <div class="row">
                                    ...
                                    <div class="product-item">
                                        <div class="pi-pic">
                                            <img src="${product.image}" alt="productImage"
                                                style="width: 270px;height: 303px;">
                                            <div class="icon">
                            ...
                            <div class="loading-more">
                                ...
                                <c:if test="${currentPage != 1}">
                                    <a href="products?page=${currentPage-1}" class="previous"
                                        style="text-decoration:none;display: inline-block;padding: 8px 16px;background-color: #2B394A;color: black;"
                                        disabled>&laquo; Previous</a>
                                </c:if>
                                <c:if test="${currentPage lt noOfPages}">
                                    <a href="products?page=${currentPage+1}" class="next"
                                        style="text-decoration:none;display: inline-block;padding: 8px 16px; background-color:#d79681; color: white;"
